...
function FormularioRegistro() {
  ...
  async function guardarDatos(e) {
   e.preventDefault()
    ...
    if(nombre==="" || correo==="" || clave==="" || edad==="" || peso==="" || estatura==="" || genero===""){
      Swal.fire({
  ...
  return (
    <div className="contenedor">
      ...
      {mostrar &&
        <div className="formulario">
          <form>
            ...
            <button className="botonS" onClick={guardarDatos}>Crear cuenta</button>
          </form>
        </div>
      }
      {mostrarAlerta && (

        <Alertas nombreAlerta={"Cuenta creada"} />
      )}
      {/* FIN CREAR CUENTA */}
      ...
      {mostrarAlerta && (
        ...
        <Alertas nombreAlerta={"Credenciales invalidas"} />
      )}
      <div>
